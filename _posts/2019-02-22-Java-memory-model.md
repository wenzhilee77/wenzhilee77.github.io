...
layout: post
title:  "Java内存区域"
categories: Java 面试 笔试 内存区域
tags:  Java 基础 面试 笔试 内存区域
author: wenzhilee77
---
...
![](/images/jmm/jmm6.jpeg)

直接指针： 如果使用直接指针访问，那么 Java 堆对象的布局中就必须考虑如何放置访问类型数据的相关信息，而reference 中存储的直接就是对象的地址。

![](/images/jmm/jmm7.jpeg)
